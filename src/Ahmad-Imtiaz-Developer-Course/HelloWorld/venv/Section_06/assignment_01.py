...
directory_containing_files = "C:/Users/goura/Documents/git/Python/src/Ahmad-Imtiaz-Developer-Course/HelloWorld/venv/Section_06/project_files" #sys.argv[1]
words_to_aggregate = ["there", "Michael", "running"] #sys.argv[2:]
